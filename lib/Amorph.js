...
Amorph.loadConverter('web3.bytes32', 'hex.prefixed', (web3Bytes32) => {
  return web3Bytes32
})
...
Amorph.loadConverter('web3.int256', 'bignumber', (web3Int) => {
  return web3Int
})
Amorph.loadConverter('bignumber', 'web3.uint256', (bignumber) => {
  return bignumber
})
Amorph.loadConverter('web3.uint256', 'bignumber', (web3Uint) => {
  return web3Uint
})
Amorph.ready()
