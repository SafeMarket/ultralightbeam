...
const pathsPojo = require('./amorphPaths')
...
Amorph.loadConverter('bignumber', 'web3.int', (bignumber) => {
  return bignumber
})
Amorph.loadConverter('web3.int', 'bignumber', (web3Int) => {
  return web3Int
})
Amorph.loadConverter('bignumber', 'web3.uint', (bignumber) => {
  return bignumber
})
...
const paths = Nobject.fromPojo(pathsPojo)

Amorph.ready({ paths: paths })
