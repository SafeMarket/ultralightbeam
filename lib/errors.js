...
module.exports = {
  ...
  TransactionRequestFromNotPersonaError: createTestableErrorClass(
    'TransactionRequestFromNotPersonaError',
    'TransactionRequest.from should be instance of Persona'
  )
}
