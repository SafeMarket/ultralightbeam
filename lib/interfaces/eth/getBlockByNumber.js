...
module.exports = new Interface('getBlockByNumber', 'eth_getBlockByNumber', {
  inputter: defunction([v.amorph, v.boolean], v.array, function inputter(blockNumber, areTransactionsObjects) {
    return [blockNumber.to(amorphHex.prefixed), areTransactionsObjects]
  }),
