...
function SolDeployTransactionRequest(ultralightbeam, bytecode, abi, inputs, _transactionRequestOptions) {
  ...
  amorphValidator.validate('SolDeployTransactionRequest argument #1', bytecode)
  arrayValidator.validate('SolDeployTransactionRequest argument #2', abi)
  arrayValidator.validate('SolDeployTransactionRequest argument #3', inputs)
  pojoValidator.validate(
    'SolDeployTransactionRequest argument #4',
